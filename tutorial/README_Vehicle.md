...
> [!IMPORTANT]
> If your vehicle not inherited from Vehicle_Base.et see [Not Common Vehicle section](#not-common-vehicle).

In your vehicle prefab find SlotManagerComponment, find CustomRadio Slot and **Enable** it, **Position** (and **Rotate**) it where you want.

> [!IMPORTANT]
> It is better to set Pibot ID to a part of the model where radio will be attached. Or you will get what is described in [Troubleshooting section](#troubleshooting)
...
If your vehicle doesn't inherited from Vehicle_Base.et you need to copy slot and actions to your vehicle.

Let's take a [Usable boats (999000999BE11000)](https://reforger.armaplatform.com/workshop/999000999BE11000-Usableboats) boat as an example.
...
You need to add to yours vehicle SlotManagerComponment new EntitySlotInfo and copy values from Vehicle_Base.et

<picture><img src="./images_veh/12.png" alt="image-12.png" style="width:auto; height: 300px"></picture>

Then you need to copy context and actions from ActionsManagerComponent of Vehicle_Base.et to your prefab ActionsManagerComponent.
...
And position slot and actions context in the same way as in the previous section.
